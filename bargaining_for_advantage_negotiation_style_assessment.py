...
questions = [
    ...
    [28, "C;I seek the middle ground", "A;I strive to achieve my goals in negotiations"],
    ...
    [28, "C;1 look for the fair compromise", "B;1 try to identify all of the underlying problems"],
...
print(f'Competing:     {totals["A"]}')
print(f'Collaborating: {totals["B"]}')
print(f'Comprimising:  {totals["C"]}')
print(f'Avoiding:      {totals["D"]}')
print(f'Accomodating:  {totals["E"]}')
